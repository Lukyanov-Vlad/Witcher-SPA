    ...
    return(
        <section className="hello_and_trailer">
                ...
                <div className="hello_text">
                    <h1 className="hello_text_title">От предназначения не уйти...</h1>
                ...
                {/* <div className="trailer">
                    <iframe width="700" height="370" src="https://www.youtube.com/embed/4ndIeNusRLI" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div> */}
